...
**Verifikation.** Load-Test-Profil *”žWeek Advance"* (siehe `## Load-Test-Plan`). Pass: Week-Tick < 60 s @ 1.000 Saves; linear bis 10k.
...
3. **Load-Test-Profil ”žWeek Advance" automatisieren** — als CI-Gate vor jedem Release-Tag.
...
- **Commands-im-SP-Modus.** Auch im Offline-SP wird jeder Command als signierte Struktur gespeichert — Voraussetzung für späteres Cloud-Verify, Achievements, BYOC. Keine ”žDirect-State-Mutations" als Convenience.
