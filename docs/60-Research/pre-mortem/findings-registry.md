...
| [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-01\|05-F-01]] — Save authentisiert Kenntnis, nicht Herkunft | security | 25 | mitigated | Score 25 + Anti-Cheat-Foundation; accepted home ADR-0116 (FMX-184; FMX-182 reference hygiene). `mitigated` = conceptually addressed, not implementation-complete. |
| [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-02\|05-F-02]] — Commands nicht signiert / replay-protected | security | 25 | mitigated | Score 25 + Cheat-Vector; accepted home ADR-0115 (FMX-184; FMX-182 reference hygiene). `mitigated` = conceptually addressed, not implementation-complete. |
...
- **Save-Schema v2 mit `SaveTrustLevel`** Konvergenz aus 5 Reports (accepted home: ADR-0116, FMX-184; FMX-182 reference hygiene):
...
- **Command-Integritaet als Cross-Cutting-Foundation** (accepted home: ADR-0115, FMX-184; FMX-182 reference hygiene):
...
|---|---|---|
| ADR-0115 | Command Integrity & Replay Protection Posture | 05 (Iter 2), FMX-184 accepted |
| Future ADR TBD | BYOC Match Validation Quorum (Future-Scope) | 06 (Iter 2), unassigned after ADR renumbering |
| ADR-0116 | Save Trust Levels & Provenance Posture | 05 (Iter 2), FMX-184 accepted |
