...
| Save-Import (Community) | Z5 → Z2 → optional Z1 | Schema-validiert; nur Server-Replay → `verified` | „Verified" nur mit vollständigem Command-Log. |

## STRIDE × Trust-Boundary (Matrix)

Zellen: ✅ = mitigiert mit Verweis · ⚠️ = teilweise · ❌ = offen · — = nicht anwendbar. Volle Verweise stehen in den Findings.

| Boundary | Spoof | Tamper | Repudiation | Info-Disc | DoS | Eskalation |
|----------|-------|--------|-------------|-----------|-----|------------|
| Z5→Z2 (Save-Import) | ⚠️ Schema-Validate · [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-04\|05-F-04]] | ⚠️ HMAC fehlt heute · [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-01\|05-F-01]] | — | ⚠️ Save kann PII enthalten · [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-09\|05-F-09]] | ⚠️ Size-Limit erforderlich · 05-F-04 | ⚠️ Prototype-Pollution-Härtung · 05-F-04 |
| Z2→Z1 (Commands) | ❌ Heute nicht signiert · [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-02\|05-F-02]] | ❌ Replay möglich · 05-F-02 | ❌ Audit-Log incomplete · 05-F-08 | ✅ TLS · `auth-flows` | ⚠️ Rate-Limits · `rate-limiting-anti-abuse` | ⚠️ Authorization-Check · 05-F-06 |
| Z3→Z2 (lokales Save laden) | — | ⚠️ AES-GCM ohne Server-HMAC · 05-F-01 | — | — | — | — |
| Z1→Z0 (Context-Bus) | — | ⚠️ In-Process-Bus · [[PM-2026-05-20-01-architecture#PM-2026-05-20-01-F-01\|01-F-01]] | ✅ Outbox-Audit · [[PM-2026-05-20-01-architecture#PM-2026-05-20-01-F-09\|01-F-09]] | — | ⚠️ Lock-Contention · 01-F-02 | ⚠️ Bounded-Context-Authz · 05-F-06 |
| Z4→Z1 (BYOC-Validator-Vote) | ⚠️ Future · [[PM-2026-05-20-06-distributed-match-compute#PM-2026-05-20-06-F-01\|06-F-01]] | ⚠️ Future · 06-F-04 | ⚠️ Future · 06-F-07 | ⚠️ Tactic-Leak · 06-F-06 | ⚠️ Geräte-Erschöpfung · 06-F-08 | ⚠️ Engine-Patch · 06-F-04 |
| Z2→Z2 (Save-Sharing) | — | ⚠️ Signatur fehlt · 05-F-01 | — | ⚠️ PII im Save · 05-F-09 | — | — |
| Server→Player-Device (Notification) | ✅ Server-signed | — | — | ✅ TLS | — | — |
...
- **OQ-TM-03.** Verifiziert der Client serverseitige `CommandReceipt`s tatsächlich? Wenn nein: Server kann Commands „verlieren" und Spieler hat keinen Beweis.
- **OQ-TM-04.** Wie modellieren wir „Account-Wechsel auf neuem Gerät" sodass das alte Gerät keine gefälschten Commands mehr senden kann? (Session-Revoke ist Pflichtschritt.)
