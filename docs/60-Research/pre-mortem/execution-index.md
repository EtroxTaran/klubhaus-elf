...
**Briefing**. Du bist für alle Themen rund um Crypto-Bausteine, Save-Format-Integrität, Command-Signing, Replay-Schutz, Audit-Log, Anti-Cheat-Foundation, Supply-Chain, Secret-Management, Account-Übernahme-Schutz, PII-Redaction zuständig. Kerntechnologien: Ed25519, HMAC-SHA-256, AES-256-GCM, BLAKE3, PBKDF2/Argon2id, WebAuthn/Passkey, cosign, sops + age, Sigstore, CycloneDX. Du baust auf [[threat-model]] auf (Trust-Zonen Z0–Z5, STRIDE-Matrix) und liefst ADRs **0026 Command Signing**, **0028 Save Trust Levels**, **0031 PII Redaction**, **0032 AI-Act-Art-50-Compliance**, **0037 SBOM-Gate**. Wichtig: dein Output muss kompatibel mit DETERMINISM-Kategorie sein (Replay-Foundation darf nicht brechen) und mit FRONTEND (Save-Format ist Frontend-Konsumiert).
...
- `docs/10-Architecture/09-Decisions/ADR-0026-command-signing-replay-protection.md`
- `docs/10-Architecture/09-Decisions/ADR-0028-save-import-export-trust-levels.md`
