---
title: "Pre-Mortem 2026-05-20 Â· Cluster Index"
status: current
...
> **Frage, die diese Ãœbung beantwortet:** Was sind die wahrscheinlichsten GrÃ¼nde, dass football-manager-x in sechs Monaten bei 10.000 Spielern gescheitert ist â€” und was tun wir *jetzt*, damit das nicht passiert?

Diese Pre-Mortem ist ein **Intent-Layer**-Dokument (`binding: false`). Empfehlungen werden Ã¼ber ADRs/GDDRs ratifiziert, nicht direkt aus diesem Cluster implementiert.
...
### Iteration 1 â€” Original 4 DomÃ¤nen
| Report | Domain | Findings | HÃ¶chster Score |
|---|---|---|---|
...
### Iteration 2 â€” Security & BYOC + Threat-Model
...
| [[threat-model]] | Trust-Boundaries & STRIDE-Matrix | â€” | â€” |

### Iteration 3 â€” Deep-Dive Coverage (12 weitere DomÃ¤nen)
| Report | Domain | Findings | HÃ¶chster Score |
|---|---|---|---|
...
| [[findings-registry]] | **Status-Tracking aller ~191 Findings mit P0â€“P4-PrioritÃ¤t** | â€” | â€” |
| [[prioritization-matrix]] | **Heatmap PÃ—I, ScoreÃ—Effort-Hebel, Cross-Cutting-Cluster Aâ€“G, Regulatorische Deadlines, Sprint-Belegung T-90â†’T-0** | â€” | â€” |
| [[execution-index]] | **15 Expertise-Kategorien (SEC, BACKEND, PLATFORM, FRONTEND, DETERMINISM, GAMEDESIGN, TEST, A11Y, LEGAL, PRODUCT, AI, COMM, BRAND, FOUNDER, SUSTAIN) â€” Briefings + Findings-Listen + Output-Artefakte fÃ¼r frische Agenten** | â€” | â€” |
...
| DAU | ~2.500 (25 % MAU) |
| Peak CCU am Match-Tick | ~200â€“400 |
| Szenario A | Single-node Hetzner (Ist) |
| Szenario B | Cloud-Autoscaling (Nutzer-Annahme) |

## Executive Summary (Iter 1+2+3 â€” ~191 Findings)

Aus ~191 Findings (40 Iter-1 + 22 Iter-2 + 129 Iter-3) verteilt auf **18 Reports + Threat-Model**, mit PrioritÃ¤ts-Tagging:
...
VollstÃ¤ndige PrioritÃ¤ts-Sortierung in [[findings-registry]].

**Acht dominante Failure-Themen:**

1. **Verbrauchsfertige Infrastruktur fehlt.** SurrealDB single-node nicht produktionserprobt fÃ¼r 10k; Migrations-Story Placeholder. ([[PM-2026-05-20-01-architecture#PM-2026-05-20-01-F-02|01-F-02]] P0, [[PM-2026-05-20-02-tech-and-ops#PM-2026-05-20-02-F-04|02-F-04]] P0, [[PM-2026-05-20-17-vendor-lifecycle-and-sustainability#PM-2026-05-20-17-F-02|17-F-02]] P1)
...
3. **Gameplay-UX-Risiken blind ohne Telemetrie.** Onboarding-60s-Spec vs RealitÃ¤t. ([[PM-2026-05-20-03-gameplay#PM-2026-05-20-03-F-03|03-F-03]] P1, [[PM-2026-05-20-07-live-ops-and-client-telemetry#PM-2026-05-20-07-F-01|07-F-01]] P1)
...
5. **Security-Fundament unvollstÃ¤ndig.** AES-GCM-Save authentisiert *Kenntnis*, nicht *Herkunft*; Commands nicht signiert/replay-geschÃ¼tzt; Supply-Chain unkontrolliert. ([[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-01|05-F-01]] P0, [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-02|05-F-02]] P0)
6. **Single-Player-Foundation MP-/BYOC-tragend oder bricht spÃ¤ter.** Save-Schema v2 + Command-Modell + Determinismus von Anfang an MP-/BYOC-kompatibel.
...
8. **Marken-Kollision SEGA/SI â€žfootball-manager-x"** â€” Rebrand vor Public-Launch zwingend. Top-3-Finalisten: Heimrunde / KlubkÃ¶nig / Formationfuchs. ([[PM-2026-05-20-08-legal-consumer-law-and-tax#PM-2026-05-20-08-F-05|08-F-05]] P0, [[PM-2026-05-20-14-brand-pr-and-crisis-comms#PM-2026-05-20-14-F-01|14-F-01]] P0)

> **Leitsatz Iteration 2/3.** *Single-Player ist das Fundament â€” aber jedes Datenformat, jeder Command-Pfad und jede State-Ãœbergangsfunktion wird so entworfen, dass sie auch unter dem strengeren Vertrauensmodell von async Multiplayer und (zukÃ¼nftig) Distributed Match Compute trÃ¤gt. Ein Stack mit zuschaltbarem Trust-Level â€” nicht zwei Stacks. MVP-Linie: kein Runtime-LLM, kein Image-Upload, kein Free-Form-Chat, kein aktives Marketing, kein Cloudflare-Workers-Lock, keine Lootboxes, keine Daily-Login-Streaks.*
...
| **2026-09-11** | CRA Vulnerability-Reporting an ENISA (24 h ab CVSS â‰¥ 9.0) | Pflicht |
...
## Risk-Heatmap (Probability Ã— Impact) â€” Iteration 1 + 2

Iter-2-Findings (Security/Report 05 + BYOC/Report 06) sind **fett markiert**. BYOC-Findings sind Future-Scope (`accepted-risk`).

|  | Impact 1 | 2 | 3 | 4 | 5 |
|---|---|---|---|---|---|
| **Probability 5** | | | | | **01-F-02 Â· 02-F-04 Â· 04-F-01** + **05-F-01 Â· 05-F-02** (Score 25) |
| **4** | | | | **01-F-01 Â· 02-F-01 Â· 02-F-10 Â· 03-F-04 Â· 04-F-04** + **05-F-04** (16) | **01-F-03 Â· 01-F-06 Â· 02-F-02 Â· 02-F-03 Â· 03-F-01 Â· 03-F-02 Â· 03-F-03 Â· 04-F-02 Â· 04-F-07** + **05-F-03 Â· 05-F-05 Â· 06-F-01 Â· 06-F-04 Â· 06-F-05** (20) |
| **3** | | | **01-F-08 Â· 01-F-10 Â· 02-F-09 Â· 03-F-07 Â· 03-F-09 Â· 03-F-10** + **05-F-11 Â· 06-F-06** (9) | **01-F-04 Â· 01-F-05 Â· 01-F-07 Â· 01-F-09 Â· 02-F-05 Â· 02-F-07 Â· 02-F-08 Â· 03-F-05 Â· 03-F-06 Â· 03-F-08 Â· 04-F-03 Â· 04-F-08 Â· 04-F-10** + **05-F-06 Â· 05-F-08 Â· 05-F-12 Â· 06-F-07 Â· 06-F-08 Â· 06-F-09 Â· 06-F-10** (12) | **02-F-06 Â· 04-F-06** + **05-F-07 Â· 05-F-09 Â· 05-F-10 Â· 06-F-02 Â· 06-F-03** (15) |
| **2** | | | | **04-F-09** (8) | **04-F-05** (10) |
| **1** | | | | | |

> Rote Zone (Score â‰¥ 20): jetzt 19 Findings (12 Iter-1 + 5 Iter-2-Security + 2 Iter-2-BYOC-`accepted-risk`) â†’ Iter-1 + Iter-2-Security sind **Mitigations vor Launch verpflichtend**; Iter-2-BYOC nur aktiviert bei Decision-Gate-Passage.
...
- **Determinismus-Drift** trifft Tech + Gameplay + Security (Anti-Cheat-Foundation) + BYOC-Voraussetzung:
  [[PM-2026-05-20-02-tech-and-ops#PM-2026-05-20-02-F-02]] â†” [[PM-2026-05-20-03-gameplay#PM-2026-05-20-03-F-02]] â†” [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-03]] â†” Foundation [[PM-2026-05-20-06-distributed-match-compute]].
- **Web-Worker-Bridge fÃ¼r Match-Engine** trifft Architektur + Gameplay (Mobile-Performance):
  [[PM-2026-05-20-01-architecture#PM-2026-05-20-01-F-04]] â†” [[PM-2026-05-20-03-gameplay#PM-2026-05-20-03-F-06]].
- **Single-Node-Outage** trifft Architektur + Monetarisierung (verlorene Conversion-Events):
  [[PM-2026-05-20-01-architecture#PM-2026-05-20-01-F-02]] â†” [[PM-2026-05-20-04-monetization#PM-2026-05-20-04-F-09]].
- **Observability ohne Dashboards** macht Auth/Anti-Abuse + Determinismus + Outbox blind:
  [[PM-2026-05-20-02-tech-and-ops#PM-2026-05-20-02-F-03]] â†” [[PM-2026-05-20-01-architecture#PM-2026-05-20-01-F-09]].
- **Save-Format-InkompatibilitÃ¤t SP â†” MP (NEU Iter 2)**: ohne Schema v2 mit `trust_level` ist SP-Save spÃ¤ter nicht fÃ¼r Cloud-Verify/Leaderboards verwendbar:
  [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-01]] â†” Single-Player-Foundation-Check in [[PM-2026-05-20-01-architecture#Iteration 2 Addendum (2026-05-20) â€” Security & Single-Player-Foundation|Report 01]] und [[PM-2026-05-20-03-gameplay#Iteration 2 Addendum (2026-05-20) â€” Security & Single-Player-Foundation|Report 03]].
- **Engine-Bundle-Hash-Rotation (NEU Iter 2)**: betrifft Save-Verify, Match-Replay und BYOC-Quorum gleichermaÃŸen:
  [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-12]] â†” [[PM-2026-05-20-06-distributed-match-compute#PM-2026-05-20-06-F-04]].
- **DSGVO-Erasure vs Audit-Aufbewahrung (NEU Iter 2)**: Pseudonymisierungs-Pflichten:
  [[PM-2026-05-20-04-monetization#PM-2026-05-20-04-F-06]] â†” [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-09]] â†” Runbook RB-S3.
- **Command-Signing als Cross-Cutting-Foundation (NEU Iter 2)**: deckt Tampering, Replay-Schutz, Audit, BYOC ab:
  [[PM-2026-05-20-05-security-and-integrity#PM-2026-05-20-05-F-02]] â†” Authorization-Checks in [[PM-2026-05-20-01-architecture#Iteration 2 Addendum (2026-05-20) â€” Security & Single-Player-Foundation|Report 01]] â†” Anti-Cheat-Hebel in [[PM-2026-05-20-03-gameplay#Iteration 2 Addendum (2026-05-20) â€” Security & Single-Player-Foundation|Report 03]] â†” Webhook-Idempotenz in [[PM-2026-05-20-04-monetization#Iteration 2 Addendum (2026-05-20) â€” Security & Single-Player-Foundation|Report 04]].

## Top-Mitigations (nach Hebel: Score Ã— 1/Aufwand) â€” Iter 1 + 2

1. **Determinism-CI-Gate** (S-Aufwand, Score 20 Ã— 4 Findings = sehr hoch). Adressiert: 02-F-02, 03-F-02, 05-F-03, Foundation fÃ¼r BYOC.
2. **Save-Schema v2 mit trust_level + Server-HMAC (Iter 2)** (L-Aufwand, Score 25). Adressiert: 05-F-01, Foundation fÃ¼r 05-F-11, Single-Player-Foundation in 01/03 Addenda. **ADR-0028 (proposed).**
...
9. **Supply-Chain-Hardening (cosign + SBOM + Renovate-QuarantÃ¤ne)** (M-Aufwand, Score 20). Adressiert: 05-F-05.
...
13. **Save-Import-HÃ¤rtung (Iter 2)** (M-Aufwand, Score 16). Adressiert: 05-F-04.
14. **Web-Worker-Bridge fÃ¼r Match-Engine** (M-Aufwand, Score 12 + Cross-Cutting). Adressiert: 01-F-04, 03-F-06.
...
> Annahme: Launch in T-180. Plan beginnt in T-90 (3 Monate vor Launch). Bei tatsÃ¤chlich anderem Launch-Datum entsprechend verschieben.

### T-90 bis T-60 â€” Foundation
...
- **Supply-Chain-Hardening (Iter 2): cosign + SBOM + Renovate-QuarantÃ¤ne** aktiv (Mit #9).
- **Webhook-Signatur + Idempotenz (Iter 2)** fÃ¼r Stripe/MCP/Webhook-Endpoints (Mit #16).

### T-60 bis T-30 â€” Validation

- **Soft-Launch / Closed-Beta in DE/CH** mit 200â€“500 Beta-Tester (04-F-04).
- **Onboarding-Usability-Test (n=20)** (Mit #10).
- **Web-Worker-Bridge** fÃ¼r Match-Engine live (Mit #14).
...
- **Save-Import-HÃ¤rtung (Iter 2)** als Beta-tauglich (Mit #13); Fuzz-Suite lÃ¤uft im CI.
- **Tampering-Test-Suite (Iter 2)** nightly aktiv; Coverage â‰¥ 95 %.

### T-30 bis T-0 â€” Hardening

- **DR-Drill voller Restore** mit echtem Daten-Volumen.
- **Tabletop-Ãœbung** mit allen Runbooks (RB-A1/2/3, RB-T1/2/3/4, RB-G1/2/3, RB-M1/2/3/4, **RB-S1/2/3 (Iter 2)**).
- **Legal-Review abgeschlossen** (AGB, Widerruf, Impressum) â€” 04-F-06.
- **Penetration-Test** durch externen Dienstleister (Gap F13) â€” Scope inkl. Save-Import, Command-Bus, Webhook-Endpoints (Iter 2).
- **WAF / Bot-Management aktiviert** (02-F-07).
- **Helpdesk live**, FAQ-Seite verÃ¶ffentlicht (04-F-08).
- **PII-Leak-Tests (Iter 2)** im CI: 0 Treffer als Release-Voraussetzung (Mit #15).
- **Recovery-Code-HÃ¤rtung (Iter 2)** validiert: single-use, time-bounded, Re-Registration-Cooldown (05-F-10).
...
- ADRs, die als Antwort entstehen, tragen `addresses: [PM-â€¦]` Frontmatter.
- Status-Tracking: [[findings-registry]].
- Obsidian-Graph: jeder Report hat `## Related` + `related:` Frontmatter â€” Backlinks aktiv.
...
- **Nach Soft-Launch:** Neue Pre-Mortem `PM-<soft-launch-date>-*` erstellen, dieses BÃ¼ndel ggf. `superseded`.
...
| F2â€“F5 Auth Implementation | 02-F-06 |
...
(VollstÃ¤ndige Abdeckung wird im Verifikations-Pass nachgezogen.)
