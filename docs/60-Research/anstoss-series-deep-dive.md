...
| **Board & president** | Season goals (often unrealistic in later seasons), board-trust % (wins +~3 %, losses âˆ’1–5 %), "win-or-fired" pressure, levers to lift trust: bank-balance > threshold, presidential palace +10 %, formal board meeting +5–10 % once per season; expert advice: do **not** negotiate goals (cost without payoff). | [^aj-vorstand1][^aj-vorstand2][^acz-rauswurf][^acz-vertrag] |
