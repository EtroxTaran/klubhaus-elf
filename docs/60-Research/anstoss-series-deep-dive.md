...
> Captures the design DNA of the AnstoÃŸ lineage as inspiration for our offline-first
...
AnstoÃŸ â€“ Der FuÃŸballmanager is a German football management series created by
Gerald KÃ¶hler at Ascon/Ascaron, starting in 1993 on Amiga and MS-DOS, released
...
- **EA FuÃŸball Manager** series (KÃ¶hler at EA after Ascaron).[^vodafone-retro]
- **We Are Football** (Winning Streak Games, 2021 / 2024 / 2027) â€” KÃ¶hler's
...
- **Anstoss 2022** (Kalypso / 2tainment) â€” instructive *failure* case showing how
  the formula breaks when balance, UI, and progression are ignored.[^a22-gamestar]
[^a22-pcgames]

## 2. The "Anstoss feeling" â€” design DNA
...
3. **Lightweight depth, not realism.** Strength is on a 1â€“13 scale (Anstoss 3),
   talent in 5 buckets, ~32 character traits â€” enough texture for emergent
...
|---|---|---|
| **Squad & contracts** | 1â€“13 strength scale, 5 talent caps (max 8/9/10/11/12), ~32 trait attributes, contract length & wage negotiation, captain/leader roles. | [^acz-attrs][^acz-info] |
...
| **Youth & scouting** | Separate youth screen, scout missions (~42 days), scout quality tied to staff salary, youth investment slider (up to several million/season), promotion gate (â‰¥17, two youth weeks). | [^aow-jugend][^acz-jugend][^acz-invest] |
| **Transfers** | Transfer list pulse at season start, age/talent arbitrage on 18â€“19y prospects, long contracts on talents, AI bidding pressure. | [^gw-tipps] |
...
| **Board & president** | Season goals (often unrealistic in later seasons), board-trust % (wins +~3 %, losses âˆ’1â€“5 %), "win-or-fired" pressure, levers to lift trust: bank-balance > threshold, presidential palace +10 %, formal board meeting +5â€“10 % once per season; expert advice: do **not** negotiate goals (cost without payoff). | [^aj-vorstand1][^aj-vorstand2][^acz-rauswurf][^acz-vertrag] |
...
| **Fan & morale** | "Stimmung" trackable in team comparison; ideal motivation ~110; praise effective only when form â‰¥ 11 (else 1:1 conversations); personal events (relationship, homesickness) drive temporary swings. | [^acz-stimmung][^acz-lob] |
...
| **Career arc** | Long-term goal: club legend â†’ eventually national-team coach (Bundestrainer); save state designed to roll across many seasons. | [^wiki-anstoss][^vodafone-retro] |

## 4. Pacing â€” season and weekly rhythm
...
explicitly customise â€” this is how Anstoss avoids forcing 7 screens per real-time
...
3. **Weekly fast-forward is the primary interaction.** A persistent "advance to
   ...
   [^retro-replay]
4. **Tabular data â†’ cards.** The 1â€“13/talent grid translates well to compact
...
7. **Frictionless onboarding > full editor.** Anstoss shipped a powerful editor;
   on mobile we ship a guided 60-second start (pick country â†’ pick fictional
   club â†’ optional manager avatar) and defer custom data to post-MVP.[^fm26-touch]
...
- **Progression loop**: club legend â†’ national team is a strong long-term goal.
- **Player rating compression**: a 1â€“13 / 5-tier-talent style scale is
  legible on phones; preferred over FM-style 1â€“20-times-30 grids.[^acz-attrs]

Hard boundaries (do **not** copy):

- **No real club, league, kit, badge or stadium names**, even with single-letter
  permutations (e.g. "PreuÃŸen Dortmund", "Oliver Huhn"). Manchester United v.
...
- **No mechanics that are legally toxic on a PWA** (gambling-style sponsor
  ...
  [^a2005-stern]
- **Federation acronyms** (e.g. Anstoss' fictional "AOFA") are inspirational â€”
...
2. **Compressed rating scale.** Use 1â€“10 strength + 4 talent buckets â€” modeled
   on Anstoss' 1â€“13 / 5-tier system but tighter for mobile readability and
...
6. **Board-trust %, not score.** Single 0â€“100 % "board trust" stat with
...
8. **Pre-season as an explicit phase.** First 6â€“7 weeks gated as a "preparation"
...
13. **Player traits ("32 character attributes" inspiration).** Trim to 8â€“12
...
- **Localisation tone.** Anstoss humour is very German. Should EN copy match
  the same tabloid-parody register, or fall back to dryer FM-style? â†’ input
  for ADR-0006 i18n.
...
- **Licensable real leagues structure.** League *structure* (tiers, promotion
  rules) is generally not protected â€” confirmable input for
  [[ip-and-licensing]].
...
[^wiki-anstoss]: Wikipedia DE â€” *Anstoss (Computerspiel)*. <https://de.wikipedia.org/wiki/Anstoss_(Computerspiel)>
[^wiki-anstoss3]: Wikipedia DE â€” *Anstoss 3*. <https://de.wikipedia.org/wiki/Anstoss_3>
[^vodafone-retro]: Vodafone Featured / Gaming â€” *Die Anstoss-Reihe: Ein RÃ¼ckblick auf den beliebten FuÃŸball-Manager*. <https://vodafone.de/featured/gaming/die-anstoss-reihe-ein-rueckblick-auf-den-beliebten-fussball-manager>
[^otb-wiki]: Wikipedia EN â€” *On the Ball (video game series)*. <https://en.wikipedia.org/wiki/On_the_Ball_(video_game_series)>
[^otb2-squakenet]: Squakenet â€” *On The Ball 2 (1997)*. <https://www.squakenet.com/game/on-the-ball-2/>
[^waf-wiki]: Wikipedia DE â€” *We Are Football*. <https://de.wikipedia.org/wiki/We_Are_Football>
[^waf-preview]: GameStar â€” *We Are Football Preview: Bringt zurÃ¼ck, was wir verloren glaubten*. <https://www.gamestar.de/artikel/we-are-football-preview-fussballmanager-gerald-koehler,3368196.html>
[^a22-gamestar]: GameStar â€” *In Anstoss ist ein guter FuÃŸballmanager versteckt, aber viel GlÃ¼ck beim Suchen* (Anstoss 2022 review). <https://www.gamestar.de/artikel/anstoss-2022-fussballmanager-test-steam-review,3386237.html>
[^a22-pcgames]: PC Games â€” *Anstoss: Der Fussballmanager Early-Access-Check â€“ holpriger Start*. <https://www.pcgames.de/Anstoss-2022-Spiel-72844/News/Early-Access-Check-1407055/2/>
[^retro-replay]: Retro Replay â€” *Anstoss 3: Der FuÃŸballmanager*. <https://retro-replay.com/db/windows/anstoss-3-der-fusballmanager/>
[^a2005-gameswelt]: Gameswelt â€” *Anstoss 2005 â€“ Test*. <https://www.gameswelt.de/anstoss-2005/test/anstoss-2005-233>
[^a2005-stern]: Stern.de â€” *"Anstoss 2005": FuÃŸball-Manager ohne den letzten Kick*. <https://www.stern.de/digital/computer/-anstoss-2005--fussball-manager-ohne-den-letzten-kick-3552106.html>
[^acz-funny]: Anstoss Coaching Zone â€” *Lustige SprÃ¼che rundum Anstoss*. <http://www.anstoss-zone.de/anstoss3/a3_sonstiges/lustige_sprueche_20.php>
[^acz-attrs]: Anstoss Coaching Zone â€” *Spielerdaten in Anstoss 3* (strength scale 1â€“13, talent tiers). <http://anstoss-zone.de/anstoss3/a3_specials/eigenschaften_20.php>
[^acz-info]: Anstoss Coaching Zone â€” *Infos Ã¼ber Anstoss 3* (interview counts, character system). <https://www.anstoss-zone.de/anstoss3/a3_infos.php>
[^acz-zeck]: Anstoss Coaching Zone â€” *Zeckenkopfs Wochen* (training plan reference). <http://www.anstoss-zone.de/anstoss3/a3_training/zeckenkopf_20.php>
[^acz-frische]: Anstoss Coaching Zone Forum â€” *Frische und Kondition hochbringen*. <http://forum.anstoss-zone.de/viewtopic.php?t=14022>
[^acz-trainings]: Anstoss Coaching Zone â€” *TrainingsplÃ¤ne fÃ¼r Anstoss*. <https://www.anstoss-zone.de/anstoss3/a3_training.php>
[^gw-tipps]: Gameswelt â€” *Anstoss 3 â€“ Allg. Tips & Tricks*. <https://www.gameswelt.de/anstoss-3/tipp/anstoss-3-allg-tips-tricks-111907>
[^aow-jugend]: Anstoss Online Wiki â€” *Jugend*. <https://wiki.anstoss-online.de/index.php/Jugend>
[^acz-jugend]: Anstoss Coaching Zone Forum â€” *Jugend fÃ¶rdern*. <http://forum.anstoss-zone.de/viewtopic.php?t=8616>
[^acz-invest]: Anstoss Coaching Zone Forum â€” *Anstoss 3 â€“ HÃ¶he Investitionen (Jugend etc.)*. <http://forum.anstoss-zone.de/viewtopic.php?t=14583>
[^aow-finanzen]: Anstoss Online Wiki â€” *Finanzen*. <https://wiki.anstoss-online.de/index.php?title=Finanzen>
[^aj-finanzen]: Anstoss JÃ¼nger â€” *Finanzen steigern*. <https://www.anstoss-juenger.de/index.php?topic=2442.0>
[^acz-bauwerke]: Anstoss Coaching Zone â€” *Bauwerke auf dem StadiongelÃ¤nde von Anstoss 3*. <http://www.anstoss-zone.de/specials/bauwerke.php>
[^aj-vorstand1]: Anstoss JÃ¼nger â€” *Vorstandsvertrauen*. <https://www.anstoss-juenger.de/index.php?topic=2433.0>
[^aj-vorstand2]: Anstoss JÃ¼nger â€” *Vertrauen des Vorstands*. <https://www.anstoss-juenger.de/index.php?topic=3419.0>
[^acz-rauswurf]: Anstoss Coaching Zone Forum â€” *Frustrierendes PrÃ¤sidium / rote Karten*. <http://forum.anstoss-zone.de/viewtopic.php?t=14351>
[^acz-vertrag]: Anstoss Coaching Zone Forum â€” *A3: VertragsverlÃ¤ngerung bei 67%*. <http://forum.anstoss-zone.de/viewtopic.php?t=10134>
[^acz-stimmung]: Anstoss Coaching Zone Forum â€” *Anstoss 3 â€“ Stimmung & Co.*. <http://www.anstoss-zone.de/phpBB3/viewtopic.php?t=13123>
[^acz-lob]: Anstoss Coaching Zone Forum â€” *Lob und Tadel*. <http://forum.anstoss-zone.de/viewtopic.php?t=15729>
[^acz-3d]: Anstoss Coaching Zone Forum â€” *Anstoss 3 problem mit 3D Spiel* (match presentation modes). <http://forum.anstoss-zone.de/viewtopic.php?t=12194>
[^acz-speed]: Anstoss Coaching Zone Forum â€” *Spielgeschwindigkeit anpassen â€“ vor allem im Szenenmodus*. <http://forum.anstoss-zone.de/viewtopic.php?t=14998>
[^aow-spielbericht]: Anstoss Online Wiki â€” *Spielbericht*. <https://wiki.anstoss-online.de/index.php?title=Spielbericht>
[^fm26-touch]: Apple App Store â€” *Football Manager 26 Touch* (mobile UI design notes). <https://apps.apple.com/de/app/football-manager-26-touch/id1626267810>
[^fm-portfolio]: Sebastian Schulz portfolio â€” *Football Manager Game (2014â€“2016)* (mobile FM UI process). <https://portfolio.sebastianbash.com/portfolio/football-manager-game/>
[^mu-sega-2020]: BAILII â€” *Manchester United Football Club Ltd v Sega Publishing Europe Ltd & Anor [2020] EWHC 1439 (Ch)*. <https://mansfield.bailii.org/ew/cases/EWHC/Ch/2020/1439.html>
[^mishcon-fm]: Mishcon de Reya â€” *Brands in Sports Video Games: Why Football Manager Might Be the Exception*. <https://www.mishcon.com/news/brands-in-sports-video-games-whyfootball-managermight-be-the-exception>
[^manfields-mu]: Mansfield BAILII case copy â€” referenced together with [^mu-sega-2020]. <https://mansfield.bailii.org/ew/cases/EWHC/Ch/2020/1439.html>
