...
[[version-pin-audit-2026-06-19]] preserves the FMX-198 Perplexity-discovery and
source-checked audit of pinned and version-like framework/library/tool
references. Current finding: `lefthook@2.1.9`, Stryker/Vitest
`9.6.1`/`4.1.9`, React/DOM `19.2.7`, TypeScript `6.0.3`, Drizzle ORM
...
and SurrealDB current stable evidence moved to 3.1.5. Accepted decisions D1-D6 live in
...
## Named Supporter Group Consent DSA and Naming (FMX-148, 2026-06-19)

[[named-supporter-group-consent-dsa-naming-2026-06-19]] preserves the FMX-148
Perplexity-first and source-checked packet closing ADR-0062's named supporter-
group surface. Nico accepted D1-D3 on 2026-06-19: `NamedSupporterGroup` is
specified but opt-in/default-off for MVP, People is not a hard blocker when A&A
uses only opaque actor/persona refs, and the legal/UGC scope is fictional
local/P2P with hosted UGC future-scope behind DSA/privacy/moderation/legal
...
youth-summary feeds. Accepted recommendation: targeted amendments to
...
& Legacy consumes immutable summaries only. Accepted decisions D1-D6 live in
...
2026-06-19 the observed current stable patch is 3.1.5, so `1.x` is no longer a
valid planning pin. Accepted recommendation: compound trigger
...
non-authoritative rebuildable projection Trial only. Accepted decisions D1-D5
live in
...
portable-export passphrase path. Accepted recommendation: use exact-pinned
...
[[fmx-105-save-trust-closure-reconciliation-2026-06-19]] preserves the FMX-105
Perplexity-first and source-checked closure sweep. Current conclusion:
FMX-105 can close without a new ADR because accepted ADR-0115 already owns
command integrity/replay protection and accepted ADR-0116 already owns save
trust/provenance/public eligibility. FMX-182 already corrected the stale
ADR-0026/ADR-0028 owner map. Closure record:
[[../40-Execution/fmx-105-save-trust-closure-record-2026-06-19]]. Raw captures:
[[raw-perplexity/raw-fmx-105-save-trust-closure-2026-06-19]],
[[raw-perplexity/raw-fmx-105-save-trust-source-checks-2026-06-19]].

## Per-Context Module Notes Surface (FMX-169, 2026-06-18)

[[per-context-module-notes-2026-06-18]] preserves the FMX-169
Perplexity-first and source-checked packet for deciding whether FMX should add
per-bounded-context module notes for the 28-context catalog. Recommendation is
accepted by Nico 2026-06-19: use a staged hybrid where
...
authoring migration. Source checks corrected the raw simplification that MVP
locales are one/other-only: current CLDR/Intl can expose `many` for FR/ES/IT,
so the control is catalog QA plus casus-slot data. Decision queue:
...
## ADR-0090 Command Queue Seam Propagation (FMX-165, 2026-06-18)

[[adr-0090-command-queue-seam-propagation-2026-06-18]] preserves the FMX-165
Perplexity-first and source-checked packet for applying accepted ADR-0090 and
ADR-0119 to downstream docs. Current truth: all PWA game-state writes go
through `CommandQueue`; commands carry `commandId` and `expectedVersion`;
confirmed projections carry `lastSeenVersion`; command responses return a new
version plus emitted events or a typed rejection; clients rehydrate from server
events before rebase; Background Sync is best-effort only; CRDT remains future
Watch Party overlay scope and LWW remains cosmetic prefs only. Decision record:
[[../40-Execution/fmx-165-command-queue-seam-decision-record-2026-06-18]]. Raw
captures:
...
## Security ADR Reference Hygiene (FMX-182, 2026-06-17)

[[security-adr-reference-hygiene-2026-06-17]] preserves the FMX-182
Perplexity-first and source-checked packet for reconciling stale security ADR
references in the pre-mortem/threat-model corpus. Current truth: ADR-0026 is
only Match Frame Contract, ADR-0027 is only PostgreSQL Data Model and ADR-0028
is only PostgreSQL Transactional Outbox. Historical command-signing intent maps
to ADR-0115; historical save-trust/provenance intent maps to ADR-0116; BYOC
Match Validation Quorum remains future-scope/unassigned. Decision record:
...
[[drift-consumer-policy-ref-contract-2026-06-17]] preserves the FMX-139
Perplexity-first and source-checked packet for defining the
`DriftConsumerPolicyRef` placeholder used by ADR-0071/GD-0024 world-drift
events. It recommends a hybrid ref/snapshot contract with stable policy ref id,
`WorldDriftPolicyCatalog` version, effect family, target context,
label/explanation keys and a minimal resolved snapshot for replay-safe consumer
ACL projections. Decisions were accepted on 2026-06-19 in
[[../40-Execution/fmx-139-drift-consumer-policy-ref-decision-queue-2026-06-17]]:
D1=C hybrid ref, D2=A AI World owns catalog identity/versioning while GD-0043 /
FMX-52 owns final values, D3=B reserved typed `youthDiffusionHint`, D4=A
proposed-only promotion path. Raw captures:
...
[[branch-protection-codeowner-activation-2026-06-16]] preserves the FMX-181
Perplexity-first and source-checked packet for GitHub ruleset migration.
Nico accepted ADR-0044 amendment/staged activation: ruleset `17748728` is the
active docs-phase `main` mirror, classic branch protection stays until verified,
Nico has PR-bypass only, and 1 approval plus CODEOWNER review waits for real
code paths plus green `quality`/`e2e`/`security` evidence. Decision record:
...
All remain draft/non-binding accepted by Nico 2026-06-19 D1-D7 in
...
Perplexity-first and source-checked packet for ADR-0075's Regulations data
follow-up. Nico accepted D1-D5: layered `LoanRegulationProfile` profiles,
focused `ObligationConditionCatalog`, Regulations-owned data shape, static
per-save rule snapshot and exact inspectable clause visibility. The packet
source-checks FIFA/RSTP, Premier League, DFL, Ligue 1/LFP and Sports
Interactive Football Manager precedent, while treating Italy-like and
Spain-like caps as fictional profile presets accepted later legal/source review.
Decision record:
...
[[career-bundestrainer-reconciliation-2026-06-15]] reconciles
[[../50-Game-Design/mode-manage-a-club-career]] with the current
...
truth. Nico chose D1-D3=A/A/A: the Bundestrainer unlock remains
`manager rep >= 75 AND 5+ in-game seasons`, major trophies raise reputation
instead of bypassing tenure, board-confidence floors and sack/warning values
remain calibration debt, and manager reputation is per-region with a global
aggregate for player-facing gates.
...
## PostgreSQL Schema Ceiling SLO Benchmark (FMX-170, 2026-06-15)

[[postgres-schema-ceiling-slo-benchmark-2026-06-15]] closes ADR-0097's concrete
schema-ceiling/archive/audit open questions. Nico accepted the recommended
D1-D3 packet: soft-warn at **300** and hard-stop at **1000** live save schemas
per single Dokploy Postgres node, user-confirmed hybrid archive pressure
(LRU suggestion only), and no platform `audit_log`. The packet keeps
whole-cluster backup/PITR distinct from per-save archive artifacts and sets a
planning restore SLO of within 30 minutes for typical archived saves until code
phase measurements replace it. Raw captures:
...
test checks one owner + one policy key per intent. Decisions were accepted on 2026-06-19 in
...
[[notification-offline-delivery-2026-06-15]] preserves the accepted
ADR-0043 -> ADR-0102 Notification platform packet. It keeps
...
accepted [[../30-Implementation/stack-currency-ledger]] and records current source
...
bundle, source-conflict policy and automation timing remain accepted by Nico 2026-06-19 in
...
[[deterministic-simulation-qa-harness-2026-06-15]] preserves the FMX-196
research layer for deterministic simulation QA, replay evidence, seed tiers,
same-WASM parity, soak metrics and save-forward compatibility. It grounds draft
[[../10-Architecture/09-Decisions/ADR-0120-deterministic-simulation-qa-and-save-forward-matrix]]
plus accepted [[../40-Quality/deterministic-simulation-qa-harness]]. No new rule is
binding after Nico approved it on 2026-06-19 D1-D7 in
...
Approved packet is all A: dedicated ADR + compliance home, hard no paid
...
Approved packet is all A: accepted GDDR + feature note, free baseline identity,
...
rollback, staged release gates and content-validation QA. It grounds accepted
[[../10-Architecture/09-Decisions/ADR-0124-pwa-offline-mobile-release-content-qa-gates]]
plus accepted [[../40-Quality/pwa-offline-mobile-release-content-qa-gates]]. The
new rule is binding after Nico approved D1-D7 on 2026-06-19 in
...
accepted ADR-0111 cleanup: Rivalry System should not publish a commercial signal;
...
remains accepted by Nico 2026-06-19 in
...
recommends accepted ADR-0113: audit/replay surfaces and projection/measurement
...
new top-level streams. Decision remains accepted by Nico 2026-06-19 in
...
research layer for generated Narrative prose replay/reopen behavior. Nico
approved the D1-D3 packet: exact persisted display snapshots for
player-visible revisitable Template/LLM prose, per-save Narrative-owned
snapshot/provenance storage and match commentary as Narrative display over
committed match events rather than `MatchFrame` or match authority. Accepted
ADR:
...
plus accepted [[../40-Quality/stryker-mutation-testing-gate]]: high-risk
...
deterministic survivor triage. Decisions were accepted on 2026-06-19 in
...
background-fast compatibility checks. Decision remains accepted by Nico 2026-06-19 in
...
calibration. Decision remains accepted by Nico 2026-06-19 in
[[../40-Execution/fmx-141-gameplay-calibration-decision-queue-2026-06-13]].
Approved packet: gameplay-wide umbrella, 14-slot taxonomy, T0-T4 harness
...
no-P2W entitlement taxonomy. The decision remains accepted by Nico 2026-06-19 in
...
recommends a dedicated accepted ADR: real-money entitlements may unlock presentation,
...
and proposes a future Vitest/fast-check architecture gate. Decision is accepted
...
gate. Decision remains accepted by Nico 2026-06-19 in
...
This feeds accepted [[../50-Game-Design/GD-0008-finance-economy]], draft
...
accepted [[../30-Implementation/club-economy-accounting-ledger]].
...
and accepted [[../30-Implementation/club-economy-commercial-contracts]].
...
accepted [[../10-Architecture/09-Decisions/ADR-0030-llm-out-of-authoritative-state]],
accepted [[../10-Architecture/09-Decisions/ADR-0054-narrative-context-and-ai-narration-framework]],
[[../50-Game-Design/GD-0018-ai-narrative-personas-and-dialogue]],
[[../20-Features/feature-ai-narration-mvp-pillar]] and
[[../30-Implementation/ai-narration-contract-testing-framework]].
...
This refines accepted [[../50-Game-Design/audience-and-atmosphere]], draft
...
[[data-generators]] and accepted [[../50-Game-Design/sponsorship-portfolio]].
...
Feeds accepted [[../50-Game-Design/GD-0023-ai-club-economy-behaviour]] and resolves the
...
[[../20-Features/feature-club-economy-mvp-pillar]], accepted
[[../10-Architecture/09-Decisions/ADR-0050-club-economy-accounting-ledger]] and
accepted [[../30-Implementation/club-economy-accounting-ledger]]. Thresholds,
...
accepted [[../50-Game-Design/economy-system]] §12 and consumes
...
This feeds accepted [[../50-Game-Design/GD-0018-ai-narrative-personas-and-dialogue]]
and accepted [[../10-Architecture/09-Decisions/ADR-0030-llm-out-of-authoritative-state]].
...
amends accepted [[../50-Game-Design/GD-0020-eos-player-skills-personas-and-people]]
