...
- Added raw research, synthesis, proposed ADR-0077 and
  [[../../10-Architecture/state-machines/player-discipline]].
- Updated ADR-0076 / ADR-0054 / GD-0018 / feature references so
  `PlayerSuspended` now points at ADR-0077 instead of a future undefined issue.
...
- Implementation remains blocked until ADR-0077 is ratified and Regulations
...
- `docs/10-Architecture/09-Decisions/ADR-0077-player-discipline-suspension-contracts.md`
...
- ADR-0077 can move from `proposed` to `accepted` only after Nico ratifies the
