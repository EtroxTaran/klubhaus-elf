...
| [[../10-Architecture/09-Decisions/ADR-0058-club-economy-commercial-impact-boundary]] | draft | Proposed Club Management commercial sub-aggregate owns ticketing policy, commercial contract lifecycle/breach, fan-event campaign choices, commercial settlement and Investor cash-grant ledger posting; other domains provide external facts. | New FMX-41 draft; FMX-44 makes the shared contract lifecycle/breach model acceptance-ready without ratifying it. |
