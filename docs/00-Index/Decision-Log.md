...
| [[../10-Architecture/09-Decisions/ADR-0057-rivalry-system-context]] | proposed | Proposed Rivalry System context owns the rivalry-edge graph (club pair × sub-score history × threshold-tier FSM), the 5-sub-score emergent formula (regional + historical + sporting + fan-incident + transfer-tension), deterministic per-season decay and threshold-tier classification (None/Mild/Strong/High/Volatile); exposes CQRS read models (RivalryScore / IsDerbyFixture / TopRivalsForClub / DerbyContext) + tier-transition events consumed by Fan Ecology / Matchday-Event-Engine / Watch Party / Manager & Legacy / Notification / Match / Tactics / Regulations; canonical Vernon scoring-context pattern (credit-rating / customer-affinity / recommendation analogues). | New FMX-34 draft. Synthesis [[../60-Research/rivalry-system-bounded-context-2026-05-28]] recommends Option C (own context). Awaiting Nico ratify decision. |
