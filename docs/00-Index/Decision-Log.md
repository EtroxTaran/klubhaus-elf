...
| [[../10-Architecture/09-Decisions/ADR-0055-tactics-context]] | proposed | Proposed Tactics context owns tactic presets, set-piece routine variants, opposition templates, role/duty configurations and tactical-style signal aggregation; produces TacticSnapshot at Match lock-time (canonical Reference + Snapshot); consumes Staff Operations Set-Piece-Coach effect-readiness; emits TacticalIdentityFingerprint to Manager & Legacy. | New FMX-28 draft. Synthesis [[../60-Research/tactics-persistence-bounded-context-2026-05-28]] recommends Option C (own context). Awaiting Nico ratify decision. |
