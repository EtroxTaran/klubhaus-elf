...
| [[../10-Architecture/09-Decisions/ADR-0051-manager-and-legacy-context]] | draft | Proposed Manager & Legacy context owns manager identity, run analysis, style signals, archetype candidates, legacy setup and prestige selection. | New FMX-16 draft; feeds Manager-Archetype Roguelite hooks. FMX-25 ratification pass added 2026-05-28: synthesis [[../60-Research/manager-legacy-bounded-context-2026-05-28]] recommends Accept (Option A). Awaiting Nico ratify decision. |
