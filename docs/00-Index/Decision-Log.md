...
| [[../10-Architecture/09-Decisions/ADR-0056-regulations-compliance-context]] | proposed | Proposed Regulations & Compliance context owns the versioned multi-regulator rule catalog (UEFA-analogue / national league / national association), transfer-window FSM, work-permit catalog, sanction catalog and licence-tier facility requirements; exposes Open Host Service + Published Language consumed by Transfer / Squad / Club / League / Staff / Match / Community Overlay; multi-context eligibility chain runs as Process Manager / Saga in the consuming BC. | New FMX-30 draft. Synthesis [[../60-Research/regulations-compliance-bounded-context-2026-05-28]] recommends Option B (own context). Awaiting Nico ratify decision. |
