...
> 2026-06-13; dossier stays closed).** FMX-141 resolved the old generic
> non-economy "FMX-52 calibration" pointers outside this dossier. Nico approved
> D1-D5 = A/A/A/A/A: gameplay-wide calibration umbrella plus economy-specific
> runbook, 14-slot taxonomy, T0-T4 harness tiers, Nico-owned baseline authority
> until delegated and realism-anchored tuning with documented fun/perception
> overrides. Authoritative records:
...
> and [[../30-Implementation/gameplay-calibration-and-soak-test-runbook]]. This
...
> completeness, added 2026-06-14; dossier stays closed).** FMX-138 resolved the
> cross-cutting deterministic-vs-seeded-variance question outside this dossier.
> Nico approved D1-D3 = A/A/A: variety surfaces are seeded while projection,
> measurement and audit surfaces stay pure; match outcome variety, injury
> occurrence and AI-manager decisions use seeded streams; existing pure
> declarations stay preserved unless explicitly reopened. Authoritative records:
...
> and [[../60-Research/determinism-portfolio-principle-2026-06-14]]. This closed
> dossier is not reopened.
...
> completeness, added 2026-06-14; dossier stays closed).** FMX-179 resolved the
> code-phase workspace/package-boundary decision outside this dossier. Nico
> approved D1-D8 = A/A/A/A/A/A/A/A: progressive one-context package catalog,
> real foundation packages only, workspace package facades, pnpm workspace links
> plus TS references plus Nx TypeScript plugin, real-target-only gates,
> `@klubhaus-elf/*`, module owner metadata before domain CODEOWNERS and fresh
> exact-pin source checks in the scaffold PR. Authoritative records:
