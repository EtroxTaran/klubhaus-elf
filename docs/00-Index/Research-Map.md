...
binding implementation guidance unless Nico promotes them into re-ratified ADRs,
feature specs, or game-design notes.

## Summary

- [Research Summary](../60-Research/00-summary.md)
- [Documentation Baseline 2026-05-22](Documentation-V1.md) - pre-reopen
...
## Wave 3 Pre-Reopen Research Inputs
...
- [Match Engine Runtime Strategy - TypeScript MVP with Polyglot Extraction Gate](../60-Research/match-engine-runtime-strategy.md) — 2026-05-17. Challenges the attached runtime technology report against pre-reopen ADRs. Pre-reopen conclusion: TypeScript as MVP authority, defines the post-MVP Rust/polyglot extraction gate, match quality profiles, interactive chunking and AI-adapter boundaries.
...
- [Player Strength Presentation - Impact Lens](../60-Research/player-strength-presentation.md) — pre-reopen locked 2026-05-17. No global OVR / universal stars; role/tactic-contextual Impact Lens; category bars from D2 1-20 attributes; separate availability status; scouting uncertainty ranges; Squad-owned `ImpactLensProjection` via `queryGateway`.
...
binding.** The triage note flags four divergences from pre-reopen decisions
...
- Promote final choices into re-pre-reopen ADRs or re-approved product/game notes.
## Related
