...
- [FMX-105 Save Trust Closure Reconciliation](../60-Research/fmx-105-save-trust-closure-reconciliation-2026-06-19.md) -
  FMX-105 Perplexity-first and source-checked closure sweep confirming that
  accepted ADR-0115 is the command-integrity/replay home and accepted ADR-0116
  is the save-trust/provenance/public-eligibility home. No new ADR or Nico
  decision is needed for closure; residual schema/browser/key-rotation details
  stay code-phase follow-ups. Closure record:
...
- [ICU-MF1 Risk Register Reconciliation](../60-Research/icu-mf1-risk-register-reconciliation-2026-06-18.md) -
  ...
  locale or ICU-syntax authoring migration reopens the risk. Decision queue:
  [FMX-161 decision queue](../40-Execution/fmx-161-icu-mf1-risk-register-decision-queue-2026-06-18.md).
- [ADR-0090 Command Queue Seam Propagation](../60-Research/adr-0090-command-queue-seam-propagation-2026-06-18.md) -
  ...
  `bounded-context-map` and the current hybrid-online PWA strategy. Current
  truth: all game-state writes route through `CommandQueue`; commands carry
  `commandId` + `expectedVersion`; projections carry `lastSeenVersion`; clients
  rehydrate from server events before rebase; Background Sync is optional
  best-effort only. Decision record:
  [FMX-165 decision record](../40-Execution/fmx-165-command-queue-seam-decision-record-2026-06-18.md).
...
- [Loan Cap and Obligation Catalog](../60-Research/loan-cap-and-obligation-catalog-2026-06-16.md) -
  ...
  focused obligation-condition catalog, Regulations-owned data shape, static
