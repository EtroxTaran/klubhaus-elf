...
type: index
binding: false
related: [[../00-Index/Feature-Map]], [[../50-Game-Design/README]]
---
...
- [[feature-async-week-loop]] — Server-driven week cycle with two cadence rule sets.
...
- [[feature-watch-party]] — Scheduled spectator broadcasts with delay.
...
- [[feature-community-editor]] — Override-pack editor + importer.
- [[feature-transfer-market-ai-and-contracts]] — AI transfer market, valuations, clauses, player terms and tiered simulation.
- [[feature-p2p-transfer-negotiation]] — Human-to-human transfers with escalation.
