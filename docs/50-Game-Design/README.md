...
- **GDDRs** (`GD-0001`...`GD-0045`; `GD-0041`–`GD-0045` are accepted after
  the June 2026 closure/promotions) — the
...
- [[GD-0024-ai-world-drift-algorithm]] - draft AI World Simulation drift
  ...
  power shifts.
- [[GD-0035-live-coaching-intervention-and-pause-rules]] - accepted live-coaching
  intervention buffer + watch-party pause-vote rules (FMX-101 + FMX-140, E8; G24):
  ...
  the disconnect pause, plus the MVP tactics pause and local pause-trust
  privilege layer. Companion to ADR-0087.
...
- [[GD-0032-awards-honours-records-and-hall-of-fame]] - accepted awards/honours/
  ...
  scarcity-capped induction, in-world + cross-save HoF, deterministic voting
  flavour with no active RNG; magnitudes = GD-0043 `legacy.hof`.
