...
- The map is updated only when Nico explicitly accepts the ADR. The current
  baseline is sixteen contexts (eleven ratified 2026-05-16; Manager &
  ...
  FMX-30 + FMX-39; Rivalry System ratified 2026-05-28 via FMX-34 +
  FMX-40).
...
- [[../10-Architecture/bounded-context-map]] — current sixteen-context baseline.
