...
- The map is updated only when Nico explicitly accepts the ADR. Until then
  the map remains the eleven-context baseline ratified 2026-05-16.
...
- [[../10-Architecture/bounded-context-map]] — current eleven-context baseline.
