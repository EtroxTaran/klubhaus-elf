<!--
id: A-006
title: [adr] Finalize i18n strategy ADR
labels: type:adr, area:docs, prio:high, size:s, parallel:after-R-007
milestone: M1 Research & Architecture
depends_on: R-007
output: docs/10-Architecture/09-Decisions/ADR-0006-i18n.md
-->

# [adr] Finalize i18n strategy ADR

**ID:** A-006  
**Labels:** `type:adr`, `area:docs`, `prio:high`, `size:s`, `parallel:after-R-007`  
**Milestone:** M1 Research & Architecture  
**Depends on:** `R-007`  
**Primary output:** `docs/10-Architecture/09-Decisions/ADR-0006-i18n.md`
...
Update `docs/10-Architecture/09-Decisions/ADR-0006-i18n.md`.
...
Read the Phase 1 summary and related research notes, then finalize `docs/10-Architecture/09-Decisions/ADR-0006-i18n.md`. Keep edits scoped to this ADR unless a broken cross-link needs correction. Do not change source code or schemas.
