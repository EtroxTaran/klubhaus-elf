<!--
id: A-007
title: [adr] Finalize IP-clean naming schema ADR
labels: type:adr, area:docs, prio:high, size:s, parallel:after-research
milestone: M1 Research & Architecture
depends_on: R-005, R-007
output: docs/10-Architecture/09-Decisions/ADR-0007-naming-schema.md
-->

# [adr] Finalize IP-clean naming schema ADR

**ID:** A-007  
**Labels:** `type:adr`, `area:docs`, `prio:high`, `size:s`, `parallel:after-research`  
**Milestone:** M1 Research & Architecture  
**Depends on:** `R-005`, `R-007`  
**Primary output:** `docs/10-Architecture/09-Decisions/ADR-0007-naming-schema.md`
...
Update `docs/10-Architecture/09-Decisions/ADR-0007-naming-schema.md`.
...
Read the Phase 1 summary and related research notes, then finalize `docs/10-Architecture/09-Decisions/ADR-0007-naming-schema.md`. Keep edits scoped to this ADR unless a broken cross-link needs correction. Do not change source code or schemas.
