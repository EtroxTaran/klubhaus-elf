      ...
      <header style={{padding:'4px 16px 8px'}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
          ...
          <div style={{textAlign:'center'}}>
            <div style={{fontSize:10, color:t.inkMute, fontWeight:700, letterSpacing:.6, textTransform:'uppercase'}}>Vergleichen</div>
            <SerifH theme={theme} style={{fontSize:16, fontWeight:700, color:t.ink}}>Spieler an Spieler</SerifH>
          </div>
      ...
      <div style={{flex:1, overflowY:'auto', padding:'12px 16px 16px'}}>
        ...
        <div style={{marginTop:12, background:t.accentSoft, border:`1px solid ${t.accent}`, borderRadius:14, padding:'12px 14px'}}>
          <div style={{display:'flex', alignItems:'flex-start', gap:10}}>
            ...
            <div>
              <SerifH theme={theme} style={{fontSize:13, fontWeight:800, color:t.accent, display:'block'}}>Empfehlung des Chef-Scouts</SerifH>
    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      ...
      <header style={{padding:'4px 16px 8px'}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
          ...
          <div style={{textAlign:'center'}}>
            <div style={{fontSize:10, color:t.inkMute, fontWeight:700, letterSpacing:.6, textTransform:'uppercase'}}>Vergleichen</div>
            <SerifH theme={theme} style={{fontSize:16, fontWeight:700, color:t.ink}}>Klub an Klub</SerifH>
          </div>
    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%', position:'relative'}}>
      ...
      <header style={{padding:'4px 16px 8px'}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
          ...
          <div style={{display:'flex', alignItems:'center', gap:8}}>
            <span style={{fontSize:9, fontWeight:800, color:t.accent, padding:'3px 8px', borderRadius:99, background:t.accentSoft, letterSpacing:.7}}>PROFI-MODUS</span>
      ...
      <div style={{padding:'0 16px'}}>
        <div style={{background:t.card, border:`1px solid ${t.rule}`, borderRadius:12, padding:'10px 14px', display:'flex', alignItems:'center', gap:10}}>
          ...
          <div style={{textAlign:'right'}}>
            <div style={{fontSize:9.5, color:t.inkMute, fontWeight:700, letterSpacing:.4, textTransform:'uppercase'}}>Gesamt</div>
    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%', position:'relative'}}>
      ...
      <header style={{padding:'4px 16px 8px'}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
          <button style={{width:36,height:36,borderRadius:10,background:t.card,border:`1px solid ${t.rule}`,display:'grid',placeItems:'center'}}><I.ChevronLeft color={t.ink} size={18}/></button>
          <div style={{textAlign:'center'}}>
            <div style={{fontSize:10, color:t.inkMute, fontWeight:700, letterSpacing:.6, textTransform:'uppercase'}}>Rolle wählen für</div>
