  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      ...
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? 'Taktik · gespeichert „Hafenstadt-Standard“' : 'Tactics · saved “Hafenstadt-Standard”'}
        title={isDe ? 'Taktik' : 'Tactics'}
        right={
...
function ScreenLineup({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%', position:'relative'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? 'Aufstellung · Northbridge auswärts' : 'Line-up · Northbridge away'}
        title={isDe ? 'Mannschaft' : 'Squad'}
        right={
          <span style={{fontSize:10, fontWeight:800, letterSpacing:.6, color:t.accent, padding:'4px 9px', borderRadius:99, background:t.accentSoft}}>{isDe ? 'STÄRKE Ø 7,4' : 'STRENGTH Ø 7.4'}</span>
        }/>
...
function ScreenStats({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? 'Saison 2026/27' : 'Season 2026/27'} title={isDe ? 'Statistiken' : 'Statistics'}
        right={
          <button style={{height:34, padding:'0 10px', borderRadius:9, background:t.card, border:`1px solid ${t.rule}`, color:t.ink, fontWeight:700, fontSize:11, fontFamily:'inherit', display:'inline-flex', alignItems:'center', gap:4}}>
