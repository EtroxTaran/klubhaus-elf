...
function App(){
  // Subscribe to prefs/locale so the whole tree re-renders when the Tweaks
  // panel changes the active club color or language. The actual mutation of
  // THEMES.A happens in system.jsx#applyClubColor.
  usePrefs();
  useT();
  return (
    <DesignCanvas>
      ...
      <DCSection id="adaptive-hub-poc"
        title="Adaptive Hub · POC"
        subtitle="Eine Komponente HubBody, drei Tiers. Phone (390px) → Tablet (768px) → Desktop (1280px). Identischer React-Code, AdaptiveShell entscheidet das Layout per CSS-Media-Queries. Production-Pattern aus plan.md §5.">
        <DCArtboard id="adaptive-hub-phone" label="Phone · 390 px" width={410} height={864}>
          <div style={{display:'grid', placeItems:'center', padding:10, background:'#f0eee9', height:'100%'}}>
            <PhoneFrame theme="A" scheme="light">
              <HubAdaptive theme="A" scheme="light"/>
            </PhoneFrame>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-hub-tablet" label="Tablet · 768 px" width={788} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <HubAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-hub-desktop" label="Desktop · 1280 px" width={1300} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <HubAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
      ...
      <DCSection id="adaptive-inbox-poc"
        title="Adaptive Inbox · POC"
        subtitle="Master-Detail: Phone zeigt nur Liste, Desktop zeigt Liste + Detail nebeneinander. Selber InboxAdaptive-Code für alle Tiers.">
        <DCArtboard id="adaptive-inbox-phone" label="Phone · 390 px" width={410} height={864}>
          <div style={{display:'grid', placeItems:'center', padding:10, background:'#f0eee9', height:'100%'}}>
            <PhoneFrame theme="A" scheme="light">
              <InboxAdaptive theme="A" scheme="light"/>
            </PhoneFrame>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-inbox-tablet" label="Tablet · 768 px" width={788} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <InboxAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-inbox-desktop" label="Desktop · 1280 px" width={1300} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <InboxAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
      ...
      <DCSection id="adaptive-squad-poc"
        title="Adaptive Squad · POC"
        subtitle="Phone: nur Kader-Liste. Tablet+: Liste + Spieler-Detail nebeneinander. Klick auf Spieler wechselt aktiven Eintrag.">
        <DCArtboard id="adaptive-squad-phone" label="Phone · 390 px" width={410} height={864}>
          <div style={{display:'grid', placeItems:'center', padding:10, background:'#f0eee9', height:'100%'}}>
            <PhoneFrame theme="A" scheme="light">
              <SquadAdaptive theme="A" scheme="light"/>
            </PhoneFrame>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-squad-tablet" label="Tablet · 768 px" width={788} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <SquadAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-squad-desktop" label="Desktop · 1280 px" width={1300} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <SquadAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
      ...
      <DCSection id="adaptive-match-poc"
        title="Adaptive Match · POC"
        subtitle="Match-Day Cockpit: Phone hat Tempo-CTA unten, Desktop bekommt rechte Stat-Spalte (Ballbesitz · xG · Ecken).">
        <DCArtboard id="adaptive-match-phone" label="Phone · 390 px" width={410} height={864}>
          <div style={{display:'grid', placeItems:'center', padding:10, background:'#f0eee9', height:'100%'}}>
            <PhoneFrame theme="A" scheme="light">
              <MatchAdaptive theme="A" scheme="light"/>
            </PhoneFrame>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-match-tablet" label="Tablet · 768 px" width={788} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <MatchAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-match-desktop" label="Desktop · 1280 px" width={1300} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <MatchAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
      ...
      <DCSection id="adaptive-finance-poc"
        title="Adaptive Finance · POC"
        subtitle="KPI-Grid passt sich der Spaltenbreite an (2 → 4 Karten). Hebel wandern bei Desktop in den Context-Rail.">
        <DCArtboard id="adaptive-finance-phone" label="Phone · 390 px" width={410} height={864}>
          <div style={{display:'grid', placeItems:'center', padding:10, background:'#f0eee9', height:'100%'}}>
            <PhoneFrame theme="A" scheme="light">
              <FinanceAdaptive theme="A" scheme="light"/>
            </PhoneFrame>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-finance-tablet" label="Tablet · 768 px" width={788} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <FinanceAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-finance-desktop" label="Desktop · 1280 px" width={1300} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <FinanceAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
      ...
      <DCSection id="adaptive-tactics-poc"
        title="Adaptive Tactics · POC"
        subtitle="Pitch + Rollen-Liste: gestapelt auf Phone, nebeneinander ab Tablet, plus Quick-Access-Buttons im Desktop-Rail.">
        <DCArtboard id="adaptive-tactics-phone" label="Phone · 390 px" width={410} height={864}>
          <div style={{display:'grid', placeItems:'center', padding:10, background:'#f0eee9', height:'100%'}}>
            <PhoneFrame theme="A" scheme="light">
              <TacticsAdaptive theme="A" scheme="light"/>
            </PhoneFrame>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-tactics-tablet" label="Tablet · 768 px" width={788} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <TacticsAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
        <DCArtboard id="adaptive-tactics-desktop" label="Desktop · 1280 px" width={1300} height={760}>
          <div style={{width:'100%', height:'100%', border:'1px solid #d9cdb4', background:'#f4ede0', overflow:'hidden'}}>
            <TacticsAdaptive theme="A" scheme="light"/>
          </div>
        </DCArtboard>
      ...
      <DCSection id="library"
        ...
        <DCArtboard id="lib-extracted" label="Extrahierte Composites" width={1200} height={1640}><LibExtracted/></DCArtboard>
