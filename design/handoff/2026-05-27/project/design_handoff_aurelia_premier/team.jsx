  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      ...
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? 'Trainingswoche · 19. Mai' : 'Training week · 19 May'} title={isDe ? 'Training' : 'Training'}
        right={
          <span style={{fontSize:11, color:t.accent, fontWeight:800, padding:'4px 10px', borderRadius:99, background:t.accentSoft}}>{isDe ? 'Sonntag: Northbridge' : 'Sunday: Northbridge'}</span>
        }/>
...
function ScreenIndividualTraining({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? '4 von 6 Slots belegt' : '4 of 6 slots filled'} title={isDe ? 'Einzeltraining' : 'Individual training'}
        right={
...
function ScreenMedical({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? 'Medizinische Abteilung' : 'Medical department'} title={isDe ? 'Krankenstation' : 'Infirmary'}
        right={
          <span style={{fontSize:11, color:t.danger, fontWeight:800, padding:'4px 10px', borderRadius:99, background:t.danger+'14'}}>{isDe ? '3 Ausfälle' : '3 sidelined'}</span>
        }/>
...
function ScreenScouting({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? '4 Scouts · 15 Beobachtungen' : '4 scouts · 15 reports'} title={isDe ? 'Scouting' : 'Scouting'}
        right={
...
function ScreenTeams({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? 'FC Hafenstadt · drei Mannschaften' : 'FC Hafenstadt · three teams'} title={isDe ? 'Vereinsstruktur' : 'Club structure'}/>
...
function ScreenStaff({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <ScreenHeader theme={theme} scheme={scheme}
        kicker={isDe ? '12 Personen · 3 Abteilungen' : '12 people · 3 departments'} title={isDe ? 'Mitarbeiter' : 'Staff'}
        right={
          <button style={{height:34, padding:'0 10px', borderRadius:9, background:t.card, border:`1px solid ${t.rule}`, color:t.ink, fontWeight:700, fontSize:11, fontFamily:'inherit', display:'inline-flex', alignItems:'center', gap:4}}>
