  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%', position:'relative'}}>
      ...
      <NegHeader theme={theme} scheme={scheme}
        kicker="Vertragsverhandlung · Marek Brody"
        title="Am Tisch sitzt der Berater."
        right={<button aria-label="Schließen" style={{width:36, height:36, borderRadius:10, background:t.card, border:`1px solid ${t.rule}`, display:'grid', placeItems:'center'}}><I.X size={16} color={t.ink}/></button>}/>
...
function ScreenBoardConfidence({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <NegHeader theme={theme} scheme={scheme}
        kicker="Vorstandssitzung · 18. Mai"
        title="Vorstandsvertrauen"/>
...
function ScreenSponsorNeg({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%', position:'relative'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <NegHeader theme={theme} scheme={scheme}
        kicker="Sponsoring · Vertragsgespräch"
        title="Korex Mobil"
        right={<span style={{fontSize:10, fontWeight:800, color:t.accent, padding:'4px 8px', background:t.accentSoft, borderRadius:99}}>RÜCKSEITE</span>}/>
...
function ScreenPressInterview({theme, scheme}){
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%', position:'relative'}}>
      <ThemeCss theme={theme} scheme={scheme}/>
      <NegHeader theme={theme} scheme={scheme}
        kicker="Auerbach-Zeitung · Mittwochsausgabe"
        title="Interview vor Northbridge"/>
